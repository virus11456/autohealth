...
METRIC_LABELS_ZH = {
    ...
    "heart_rate_min": "心率最低",
    "heart_rate_max": "心率最高",
    "heart_rate_std": "心率波動 (std)",
    "heart_rate_samples": "心率樣本數",
    "readiness": "恢復分數",
    "env_stress": "環境壓力分數",
    "bedtime_hour": "上床時間 (24+ 制)",
    # Phase 5 prep — names align with scripts/parse_health.py canonical schema
    "hr_recovery_1min": "1 分鐘心率恢復",
    "wrist_temp_delta_c": "睡眠手腕溫差",
    "walking_speed_mps": "步行速度",
    "step_length_cm": "步長",
    "walking_steadiness": "步行穩定度",
    "six_min_walk_m": "6 分鐘步行距離",
    "basal_kcal": "基礎代謝",
